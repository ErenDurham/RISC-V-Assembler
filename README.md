...
## Overview
This project implements a fully functional assembler for the RISC-V instruction set architecture (ISA). The software automates the translation of assembly source code (`.s`) into machine-readable binary (`.bin`) and hexadecimal text (`.hex.txt`) formats. It features a parsing engine capable of handling memory initialization, label resolution, and standard assembly directives.
